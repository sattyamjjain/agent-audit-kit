...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-194-blue.svg" alt="Rules: 194"></a>
...
- **<!-- rule-count:total -->194<!-- /rule-count --> rules** across 11 security categories, covering the 2026 CVE wave
...
jobs:
  scan:
    ...
    steps:
      ...
      - uses: sattyamjjain/agent-audit-kit@v0.3.16
        with:
          fail-on: high
```
...
**<!-- rule-count:total -->194<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| Detection rules (static) | **<!-- rule-count:total -->194<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
