...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-161-blue.svg" alt="Rules: 161"></a>
...
- **<!-- rule-count:total -->161<!-- /rule-count --> rules** across 11 security categories, covering the 2026 CVE wave
...
**<!-- rule-count:total -->161<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| --- | --- | --- |
| **ASI01** | Goal Hijack | 7 |
| **ASI02** | Tool Misuse | 14 |
| **ASI03** | Memory Poisoning | 42 |
| **ASI04** | Identity & Privilege Abuse | 26 |
...
| **ASI09** | Resource Abuse | 8 |
| **ASI10** | Supply-Chain | 7 |
<!-- owasp-coverage:end -->
...
| Detection rules (static) | **<!-- rule-count:total -->161<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
