...
<p align="center">
  ...
  <a href="#what-it-finds"><img src="https://img.shields.io/badge/rules-350-blue.svg" alt="Rules: 350"></a>
...
<!-- rule-count:total -->350<!-- /rule-count --> rules across 14 security categories:
...
says so instead of printing a tick. Full list of the <!-- rule-count:total -->350<!-- /rule-count -->
...
<!-- test-count:total -->2,411<!-- /test-count --> tests. 27 CLI commands. Releases are Sigstore-signed
and ship a deterministic rule bundle.

Mechanical fix recipes cover <!-- fix-recipe-coverage:count -->11<!-- /fix-recipe-coverage --> of <!-- rule-count:total -->350<!-- /rule-count --> rules
