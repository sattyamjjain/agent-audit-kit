...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-288-blue.svg" alt="Rules: 288"></a>
...
- **<!-- rule-count:total -->288<!-- /rule-count --> rules** across 12 security categories, covering the 2026 CVE wave
...
**<!-- rule-count:total -->288<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| Detection rules (static) | **<!-- rule-count:total -->288<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
