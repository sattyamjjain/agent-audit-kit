...
|---------|:---:|:---:|:---:|:---:|:---:|
| **Rules** | <!-- rule-count:total -->362<!-- /rule-count --> | ~10 | 20 codes (v0.5.x) / 15 risks (v0.6+) [†](#snyk-rule-count) | 57 | N/A (runtime) |
...
| Rule count | <!-- rule-count:total -->362<!-- /rule-count --> | Not publicly disclosed |
