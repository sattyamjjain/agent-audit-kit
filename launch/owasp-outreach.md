...
332 rules across 98 scanners cover:
...
I built AgentAuditKit, an open-source (MIT) security scanner for MCP-connected AI agent pipelines. It maps 332 detection rules to all 10 risks in the OWASP MCP Top 10:
...
Hey everyone — I built an open-source security scanner for MCP agent configs. 332 detection rules that catch hardcoded secrets, shell injection, tool poisoning (invisible Unicode in tool descriptions), and rug pull attacks.
