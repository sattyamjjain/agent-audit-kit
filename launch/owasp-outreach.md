...
340 rules across 101 scanners cover:
...
I built AgentAuditKit, an open-source (Apache-2.0) security scanner for MCP-connected AI agent pipelines. It maps 340 detection rules to all 10 risks in the OWASP MCP Top 10:
...
Hey everyone — I built an open-source security scanner for MCP agent configs. 340 detection rules that catch hardcoded secrets, shell injection, tool poisoning (invisible Unicode in tool descriptions), and rug pull attacks.
