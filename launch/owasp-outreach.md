...
321 rules across 94 scanners cover:
...
I built AgentAuditKit, an open-source (MIT) security scanner for MCP-connected AI agent pipelines. It maps 321 detection rules to all 10 risks in the OWASP MCP Top 10:
...
Hey everyone — I built an open-source security scanner for MCP agent configs. 321 detection rules that catch hardcoded secrets, shell injection, tool poisoning (invisible Unicode in tool descriptions), and rug pull attacks.
