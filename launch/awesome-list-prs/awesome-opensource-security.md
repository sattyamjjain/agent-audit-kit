...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 339 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 339 rules across 100 scanner modules
