...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 340 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 340 rules across 101 scanner modules
