...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 303 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 303 rules across 90 scanner modules
