...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 308 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 308 rules across 92 scanner modules
