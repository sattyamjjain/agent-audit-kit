...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 296 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 296 rules across 89 scanner modules
