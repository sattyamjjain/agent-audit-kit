...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 345 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 345 rules across 102 scanner modules
