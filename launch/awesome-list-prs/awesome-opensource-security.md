...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 341 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 341 rules across 101 scanner modules
