...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 275 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 275 rules across 86 scanner modules
