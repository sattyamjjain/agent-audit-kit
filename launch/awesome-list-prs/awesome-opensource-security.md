...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 330 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 330 rules across 98 scanner modules
