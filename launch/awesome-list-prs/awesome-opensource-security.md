...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 351 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 351 rules across 103 scanner modules
