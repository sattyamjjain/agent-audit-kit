...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 299 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 299 rules across 89 scanner modules
