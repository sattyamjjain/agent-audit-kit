...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 313 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 313 rules across 93 scanner modules
