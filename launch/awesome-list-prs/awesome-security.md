...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines — 313 detection rules, OWASP MCP/Agentic Top 10 coverage, SARIF output, fully offline.
```
...
- **313 rules** across 13 security categories
