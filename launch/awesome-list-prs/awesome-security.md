...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines — 321 detection rules, OWASP MCP/Agentic Top 10 coverage, SARIF output, fully offline.
```
...
- **321 rules** across 14 security categories
