...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines — 361 detection rules, OWASP MCP/Agentic Top 10 coverage, SARIF output, fully offline.
```
