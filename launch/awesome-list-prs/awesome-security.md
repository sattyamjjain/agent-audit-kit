...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines — 275 rules, OWASP MCP/Agentic Top 10 coverage, SARIF output, fully offline.
```
...
- **275 rules** across 12 security categories
